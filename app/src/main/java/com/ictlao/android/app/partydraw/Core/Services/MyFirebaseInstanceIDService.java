...
public class MyFirebaseInstanceIDService extends Service{
    ...
    public void onCreate() {
        ...
        mInternetProvider = new InternetProvider(MyFirebaseInstanceIDService.this);
        ...
        if(mInternetProvider.isConnected()) {
        ...
        mCheckNotificationMessage.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (mArrayMessageSizes.size() > 0) {
                    ...
                    intent.putExtra("Group_Password", mGroupPassword);
    ...
    public void onTaskRemoved(Intent rootIntent) {
        if(this.getClass() == null || this.getPackageName().equals("")) {
            return;
        }else {
            Intent restartServiceIntent = new Intent(this.getApplicationContext(), this.getClass());
